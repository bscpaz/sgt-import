...
@Entity
@Table(name = AssuntoCarga.TABLE_NAME, schema = Schema.PUBLIC)
public class AssuntoCarga {
	
	public static final String TABLE_NAME = "tb_assuntos_carga";
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AssuntoCarga other = (AssuntoCarga) obj;
		if (codigo == null) {
